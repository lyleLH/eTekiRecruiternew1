...
//  eTekiRecruiter
//
//  Created by Siva Sagar Palakurthy on 26/09/19.
...
extension ImagePicker {
    ...
    private func showAlert(targetName: String, completion: @escaping (Bool)->()) {
        DispatchQueue.main.async { [weak self] in
            ...
            //View Hirarchy issue fixed in Camera gallery of Create Job
            self.getTopMostViewController()?.present(alertVC, animated: true, completion: nil)
